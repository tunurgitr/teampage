...
using TeamPage.Web.Models.AccountViewModels;
...
namespace TeamPage.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost("/account/external-login-callback")]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        ...
        [HttpPost("/account/external-login-confirmation")]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
